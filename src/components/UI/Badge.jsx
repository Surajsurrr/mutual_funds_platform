...
export const Spinner = ({ size = 'md', className = '' }) => {
  ...
  return (
    <svg className={`animate-spin ${sizes[size]} ${className}`} style={{ color: '#12B4C3' }} fill="none" viewBox="0 0 24 24">
...
export const SkeletonCard = () => (
  <div className="rounded-2xl p-6 space-y-4"
    style={{ background: '#121C33', border: '1px solid rgba(18,180,195,0.1)' }}>
...
export const Divider = ({ label, className = '' }) => (
  <div className={`flex items-center gap-3 ${className}`}>
    <div className="flex-1 h-px" style={{ background: 'rgba(18,180,195,0.15)' }} />
...
export const EmptyState = ({ icon: Icon, title, description, action }) => (
  <div className="flex flex-col items-center justify-center py-16 gap-4 text-center">
    {Icon && (
      <div className="p-5 rounded-full" style={{ background: 'rgba(18,180,195,0.1)', color: '#3ECFDC' }}>
        <Icon size={32} />
      </div>
    )}
    <div>
